...
CREATE TABLE product (
    ...
    product_status VARCHAR(10) NOT NULL DEFAULT 'ACTIVE', -- ACTIVE, INACTIVE
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE orders (
    ...
    status VARCHAR(10) NOT NULL DEFAULT 'PENDING', -- PENDING, CONFIRMED, SHIPPED, CANCELLED, COMPLETED
    note TEXT NULL,
...
CREATE TABLE payment (
    ...
    method VARCHAR(10) NOT NULL, -- CASH, BANK
...
CREATE TABLE shipment (
    ...
    shipment_status VARCHAR(10) NOT NULL DEFAULT 'PENDING', -- PENDING, SHIPPED, DELIVERED, CANCELLED
...
CREATE TABLE review (
    ...
    comment TEXT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    -- review_status VARCHAR(10) DEFAULT 'PENDING', -- PENDING, APPROVED, REJECTED 
